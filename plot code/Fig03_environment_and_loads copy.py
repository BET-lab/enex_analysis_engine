...
def main() -> None:
    ...
    cooling_load_kw = df["DistrictCooling:Facility [W](TimeStep)"].to_numpy() * enex.W2kW
    heating_load_kw = df["DistrictHeatingWater:Facility [W](TimeStep)"].to_numpy() * enex.W2kW
